...
public class Interceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //有ST
        //1.向SSO詢問ST是否有效
        String url = "http://35.247.95.83:9090/sso/verify?ST=" + st + "&serverId=1";
//        String url = "http://localhost:9090/sso/verify?ST=" + st + "&serverId=1";
        ...
        if (!verify) {
            ...
            setCookie(response, "example1", jwt);
            log.info("jwt: {}", jwt);
    ...
    public boolean redirect( HttpServletResponse response) throws IOException {
        ...
        map.put("location", "http://35.247.95.83:80/login?service=http://34.81.61.77:80/home&serverId=1");
//        map.put("location", "http://localhost:3000/login?service=http://localhost:3001/home&serverId=1");
